...
public class Constants {
	...
	public static final String RESOURCE_URI_NS = "http://localhost:8080/ArtsCombinatoriesRest/resource/";		// This cannot be changed without updating all existing objects IDs
