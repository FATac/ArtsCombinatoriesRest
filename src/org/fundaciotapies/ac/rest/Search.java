...
public class Search {
	...
	public String search(@QueryParam("s") String word, @QueryParam("c") String className, @QueryParam("k") String color, @QueryParam("u") String uid) {
		Map<String, CustomMap> result = new Request().search(word, className, color, uid);
